...
| **[h5i](https://github.com/h5i-dev/h5i)** | Open-source Rust CLI that runs multiple coding agents (Claude Code, Codex) on a task in isolated git-worktree sandboxes, has them peer-review each other, then a neutral verifier replays and tests each candidate before merging the one that passes; every run's prompts, models, commands, logs, policies, and verdict are versioned in the repo under refs/h5i/* for an auditable, defensible review trail | [![GitHub](https://img.shields.io/github/stars/h5i-dev/h5i)](https://github.com/h5i-dev/h5i) |
