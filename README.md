...
| **[WalletPrint](https://github.com/Loai17/walletprint-sdk)** | Behavioral transaction risk scoring for AI agent wallets — scores proposed transactions against the wallet's own behavioral history before signing, flagging new recipients, size outliers, velocity spikes, and unfamiliar contract types with plain-English reason codes | [![GitHub](https://img.shields.io/github/stars/Loai17/walletprint-sdk)](https://github.com/Loai17/walletprint-sdk) |
